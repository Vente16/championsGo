<?php 
   ...
   require_once "conexion.class.php";
    ...
    class autocompletar{
      ...
      public function autocompletarEquipos(){
      
        $sql = "SELECT * FROM equipos WHERE disponible=1 AND estado=1 ORDER BY id_torneo DESC";
        $query = $this->con->prepare($sql);
        $query->execute();
        $arreglo = array();

        foreach ($query as $torneo) {
         $arreglo[] =  $torneo['nombre_equipo'];
   ...
   print_r($ob->autocompletarEquipos());*/
